//
//  PunkBeerEndpoint.swift
//  PUNKBeers
//
//  Created by Heitor Souza on 7/19/17.
...
class PunkBeerEndpoint{
    ...
    static func loadBeers(beerPage: Int, onComplete: @escaping ([Beer]?) -> Void){
            ...
            if error != nil {
                ...
                if response.statusCode == 200 {
                    ...
                    for item in json {
                        ...
                        let beer = Beer(id: id, name: name , abv: abv, imageUrl: imageUrl, tagLine: tagLine, ibu: ibu, description: description)
